						...
						<div className="flex h-16 justify-between">
							...
							<div className="hidden sm:ml-6 sm:flex sm:items-center">
								<Menu as="div" className="relative ml-3">
									<div>
										<MenuButton className="flex rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-slate-500 focus:ring-offset-2">
									...
									>
										<MenuItems className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
											{token ? (
												<MenuItem>
													<button
														className="data-[active]:bg-gray-100 flex w-full px-4 py-2 text-sm text-gray-700"
														onClick={() => {
												...
												<MenuItem>
													<Link to={`/login`}>
														<button className="data-[active]:bg-gray-100 flex w-full px-4 py-2 text-sm text-gray-700">
															Sign in
														</button>
													</Link>
												</MenuItem>
